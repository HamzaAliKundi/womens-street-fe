...
const Home = () => {
  ...
  const handleAddToCart = async (product) => {
    ...
    try {
      ...
      // Remove loading for this product
          ...
          <div className="text-center mb-16 animate-fade-in">
           ...
           <div className="flex flex-wrap justify-center gap-6 mb-16 animate-fade-in">
             <button
               ...
               className={`px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-md ${
                 activeCategory === 'all'
             ...
             {apiCategories.map((category, index) => (
               <button
                 ...
                 className={`px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-md animate-fade-in ${
              ...
              {filteredProducts.map((product, index) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <p className="text-sm text-gray-600 mb-4 line-clamp-3 leading-relaxed flex-grow">{product.description}</p>
                      ...
                      {(() => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full py-3 px-6 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-sm ${
                              isOutOfStock
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-pink-500 to-purple-500 mx-auto mb-6"></div>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Experience luxury shopping with our premium services and exceptional quality</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group animate-fade-in" style={{animationDelay: '0.2s'}}>
              ...
              <p className="text-gray-600 leading-relaxed">Complimentary delivery on all orders over PKR 5,000 across Pakistan</p>
            </div>
            ...
            <div className="text-center group animate-fade-in" style={{animationDelay: '0.4s'}}>
              ...
              <p className="text-gray-600 leading-relaxed">7-day exchange policy with authentic quality assurance on all products</p>
            </div>
            ...
            <div className="text-center group animate-fade-in" style={{animationDelay: '0.6s'}}>
              ...
              <p className="text-gray-600 leading-relaxed">Dedicated WhatsApp support team available during business hours</p>
            </div>
          </div>
        </div>
      </section>
